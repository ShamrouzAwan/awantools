...
function render_admin(string $title, string $content, array $opts = []): void {
    ...
    $navItems = [
        ...
        ['href' => '/admin/seo',           'label' => 'SEO Settings',     'icon' => 'seo',       'section' => 'seo'],
        ['href' => '/admin/seo-pages',     'label' => 'Page SEO Manager', 'icon' => 'seo-pages', 'section' => 'seo-pages'],
    ...
    $icons = [
        ...
        'seo-pages' => '<svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="11" y2="17"/><circle cx="14" cy="16" r="2"/><path d="m19 21-1.5-1.5"/></svg>',
