    ...
    static function categories(): array
    {
        return [
            ...
            'awan_tools' => [
                'name'           => 'Awan Tools',
                'icon'           => 'plug',
                'description'    => 'Branded plugin cards with logo, badges, and stats',
                'default_width'  => 1200,
                'default_height' => 630,
                'templates'      => [
                    'light' => ['name' => 'Light',       'desc' => 'Light lavender style (clean & modern)'],
                    'dark'  => ['name' => 'Dark Neon',   'desc' => 'Dark neon space style'],
                    'neon'  => ['name' => 'Cyber Purple', 'desc' => 'Deep purple cyber style'],
                ],
                'defaults' => [
                    'light' => [
                        'bg_color'          => 'f3f0ff',
                        'heading_color'     => '1a1040',
                        'description_color' => '4b5563',
                        'accent_color'      => '6d4fe8',
                        'heading'           => 'Advanced Plugin',
                        'subheading'        => 'FOR WORDPRESS',
                        'description'       => 'The ultimate plugin for WordPress. Add, manage & style everything effortlessly. Lightweight. Fast. Powerful.',
                        'stat1_value'       => '50K+',
                        'stat1_label'       => 'Active Installs',
                        'stat2_value'       => '4.9/5',
                        'stat2_label'       => 'Average Rating',
                        'stat3_value'       => '200K+',
                        'stat3_label'       => 'Downloads',
                    ],
                    'dark' => [
                        'bg_color'          => '070712',
                        ...
                        'accent_color'      => '6366f1',
                        'heading'           => 'Preview Any.',
                        'subheading'        => 'Customize All.',
                        'description'       => 'The ultimate plugin to test, customize, and generate stunning previews in real-time. All in one powerful toolkit.',
                        'badge1'            => 'Fast & Lightweight',
                        'badge1_sub'        => 'Optimized for Speed',
                        'badge2'            => 'Secure & Reliable',
                        'badge2_sub'        => 'Built with Best Practices',
                        'badge3'            => 'Highly Customizable',
                        'badge3_icon'       => 'code',
                        'badge3_sub'        => 'Tailor Everything',
                        'stat1_value'       => '25,000+',
                        'stat1_label'       => 'Active Installs',
                        'stat2_value'       => '100,000+',
                        'stat2_label'       => 'Previews Generated',
                        'stat3_value'       => '4.9/5',
                    ...
                    'neon' => [
                        'bg_color'          => '0d0820',
                        'heading_color'     => 'ffffff',
                        'description_color' => 'c4b5fd',
                        'accent_color'      => '22d3ee',
                        'heading'           => 'Plugin Name',
                        'subheading'        => 'TAGLINE HERE',
                        'description'       => 'Short description of what this plugin does. Add, manage & extend everything. Lightweight, fast and powerful.',
                        'stat1_value'       => '10K+',
                        'stat1_label'       => 'Active Installs',
                        'stat2_value'       => '5.0/5',
                        'stat2_label'       => 'Average Rating',
